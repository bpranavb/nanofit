...
**Full URL:**
```
https://tablet-bugfix.preview.emergentagent.com/api/upload/person
```
...
2. **URL:** `https://tablet-bugfix.preview.emergentagent.com/api/upload/person`
...
### Basic Test
```bash
curl -X POST https://tablet-bugfix.preview.emergentagent.com/api/upload/person \
...
✅ **Endpoint:** `https://tablet-bugfix.preview.emergentagent.com/api/upload/person`  
✅ **Method:** POST  
